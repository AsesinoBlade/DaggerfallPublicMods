...
{
    public class VSPCharacterSheetOverride : AsesinoCharSheetWindow
    {
        ...
        public new static int CurrentTallyCount(DFCareer.Skills skill)
        {
            int i = (int)skill;
        ...
        public new static int TallysNeededToAdvance(DFCareer.Skills skill)
        {
            int i = (int)skill;
